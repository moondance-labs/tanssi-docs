...
def extract_category(category, shared_data=None): 
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        f.write("It is intended for use with large language models (LLMs) to support developers working with Tanssi. The content includes selected pages from the official docs, organized by section.\n\n")
