...
description: Follow these step-by-step instructions to configure a proxy account to manage Sequencer activities on behalf of your primary block producer account.
