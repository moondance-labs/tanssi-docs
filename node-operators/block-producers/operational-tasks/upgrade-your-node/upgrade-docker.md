---
title: Upgrade your Docker Node
...
This tutorial covers upgrading your Tanssi block producer node configured via Docker. This guide assumes that you've already set up your account and spun up a [block producer node with Docker](/node-operators/block-producers/onboarding/run-a-block-producer/block-producer-docker/){target=\_blank}. 
