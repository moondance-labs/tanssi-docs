...
For the purposes of this guide, you'll need to have MetaMask installed and configured to work with your Tanssi EVM Appchain. You can follow [this guide to configure MetaMask for Tanssi with the demo EVM Appchain](/dapp-developers/developer-toolkit/ethereum-api/wallets/metamask/){target=\_blank}.
...
![File explorer](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-1.webp)
...
![Create a new file for your Solidity contract](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-2.webp)

Next, paste the following smart contract into the editor tab:

```solidity
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/dev-env/remix/erc20.sol'
```

![Paste the contract into the editor](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-3.webp)
...
![Compile MyToken.sol](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-4.webp)
...
![Change environment to injected Web3](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-5.webp)
...
![Select accounts to connect to Remix](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-6.webp)
...
![Enter an token balance and deploy](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-7.webp)
...
![Confirmed label on a transaction](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-8.webp)
...
![Interact with the contract from Remix](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-9.webp)
...
![Add a token](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-10.webp)
...
![Paste the copied contract address](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-11.webp)
...
![Add the tokens to your MetaMask account](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-12.webp)
...
![Confirmation of the token transfer](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-13.webp)
...
![Verify the reduction in account balance](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-14.webp)
...
![Check transaction status on block explorer for your Tanssi Appchain](/images/dapp-developers/developer-toolkit/ethereum-api/dev-environments/remix/remix-15.webp)
