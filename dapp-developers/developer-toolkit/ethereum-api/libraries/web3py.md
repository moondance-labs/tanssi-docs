...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/balances.py'
```
...
![Check Balance Ethers.js](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-1.webp)
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/transaction.py'
```
...
![Send Tx Web3.py](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-2.webp)
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/compile.py'
```
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/deploy.py'
```
...
![Deploy Contract Web3py](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-3.webp)
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/get.py'
```
...
![Read from Contract Web3py](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-4.webp)
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/increment.py'
```
...
![Increment Contract Web3py](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-5.webp)
...
```python
--8<-- 'code/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/reset.py'
```
...
![Reset Contract Web3py](/images/dapp-developers/developer-toolkit/ethereum-api/libraries/web3py/web3py-6.webp)
