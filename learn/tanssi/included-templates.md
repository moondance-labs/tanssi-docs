...
With this EVM template, developers can have a [Moonbeam](https://moonbeam.network){target=_blank}-like ContainerChain in no time and add their own custom logic and features specific to their own use case.
