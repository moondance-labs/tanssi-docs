...
???+ code "hardhat.config.js"
    ...
    ```js
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/hardhat-config.js'
    ```
...
???+ code "MyTok.sol"
    ...
    ```solidity
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/MyTok.sol'
    ```
...
![Compile contracts using Hardhat](/images/explore/integrations/indexers/subsquid/erc20-transfers/subsquid-1.webp)
...
2. In the `deploy.js` file, go ahead and add the following script:
    ...
    ???+ code "deploy.js"
        ...
        ```ts
        --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/deploy.js'
        ```
...
???+ code "transactions.js"
    ...
    ```ts
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/transactions.js'
    ```
...
![Send transactions using Hardhat](/images/explore/integrations/indexers/subsquid/erc20-transfers/subsquid-2.webp)
...
???+ code "schema.graphql"
    ...
    ```graphql
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/schema.graphql'
    ```
...
??? code "ERC-20 ABI"
    ...
    ```json
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/erc20.json'
    ```
...
![Run Subsquid commands](/images/explore/integrations/indexers/subsquid/erc20-transfers/subsquid-3.webp)
...
???+ code "processor.ts"
    ...
    ```ts
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/processor.ts'
    ```
...
???+ code "main.ts"
    ...
    ```ts
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/main.ts'
    ```
...
![Get Squid running](/images/explore/integrations/indexers/subsquid/erc20-transfers/subsquid-4.webp)
...
???+ code "Example query"
    ...
    ```ts
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/sample-query.graphql'
    ```

![Running queries in GraphQL playground](/images/explore/integrations/indexers/subsquid/erc20-transfers/subsquid-5.webp)
...
??? code "main.ts"
    ...
    ```ts
    --8<-- 'code/explore/integrations/indexers/subsquid/erc20-transfers/main-with-logging.ts'
    ```
