...
![Get started with SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-1.webp)

On the following screen, you'll be prompted to create a password to secure your new wallet.

![Create a password for SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-2.webp)
...
![Back up your seed phrase in SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-3.webp)
...
![Import account part 1](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-4.webp)
...
![Import existing account part 2](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-5.webp)
...
![Toggle support for the Dancebox TestNet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-6.webp)
...
![See your TestNet account balances in SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-7.webp)
...
![Add Network in SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-8.webp)
...
![Connect to Polkadot.js Apps](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-9.webp)
...
![Connect SubWallet to Polkadot.js Apps](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-10.webp)
...
![Send funds through Substrate API with Polkadot.js Apps](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-11.webp)
...
![Send funds through Substrate API directly in SubWallet](/images/explore/developer-toolkit/substrate-api/wallets/subwallet/subwallet-12.webp)

This guide focused specifically on configuring SubWallet to work with your Tanssi Substrate Appchain, but SubWallet is also a full-featured wallet for EVM accounts. Under the Ethereum API section, you'll find a [similar guide for configuring SubWallet for use with your Tanssi EVM Appchain](/explore/developer-toolkit/ethereum-api/wallets/subwallet){target=\_blank}.
