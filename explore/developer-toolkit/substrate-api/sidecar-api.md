...
![Successful Output](/images/explore/developer-toolkit/substrate-api/sidecar-api/sidecar-1.webp)
...
```typescript
--8<-- 'code/explore/developer-toolkit/substrate-api/sidecar/sidecar-transfer.ts'
```
