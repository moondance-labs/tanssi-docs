...
![Metamask Setup Interface](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-1.webp)
...
![Importing account from private key metamask menu](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-2.webp)

Next, click on **Import Account**.

![Importing account from private key account switcher menu](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-3.webp)
...
![Paste your account key into MetaMask](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-4.webp)

You should end up with an imported **Account 2** that looks like this:

![MetaMask displaying your new Account 2](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-5.webp)
...
![Add new network in Metamask menu](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-6.webp)

Next, go to the bottom of the page and click on **Add network manually**:

![Add network manually in Metamask](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-7.webp)
...
![Add network in Metamask](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-8.webp)
...
![Successfully added a network in Metamask](/images/explore/developer-toolkit/ethereum-api/wallets/metamask/metamask-9.webp)
