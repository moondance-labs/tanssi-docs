...
```ts
--8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/read-chain-data.ts'
```
...
```ts
--8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/write-chain-data.ts'
```
...
!!! note
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/browser-based-wallets.ts'
    ```
...
???+ code "View balances.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/balances.ts'
    ```
...
![The result of running the balances script in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-1.webp)
...
???+ code "View transaction.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/transaction.ts'
    ```
...
![The result of running the transaction and balances scripts in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-2.webp)
...
--8<-- 'text/explore/developer-toolkit/ethereum-api/libraries/compile-ts.md'

```js
--8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/compile.ts'
```
...
???+ code "View deploy.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/deploy.ts'
    ```
...
![The result of running the deploy script in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-3.webp)
...
???+ code "View get.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/get.ts'
    ```
...
![The result of running the get script in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-4.webp)
...
???+ code "View increment.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/increment.ts'
    ```
...
![The result of running the increment and get scripts in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-5.webp)
...
???+ code "View reset.ts"
    ...
    ```ts
    --8<-- 'code/explore/developer-toolkit/ethereum-api/libraries/viem/reset.ts'
    ```
...
![The result of running the reset and get scripts in the terminal](/images/explore/developer-toolkit/ethereum-api/libraries/viem/viem-6.webp)
