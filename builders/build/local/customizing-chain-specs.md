...
An example of a non-manually editable attribute is the one containing the Wasm runtime (in the genesis state section), which is an hexadecimal representation of a binary blob generated by the compiler. Still, apart from this, most of the properties are easy to edit before launching the network.
