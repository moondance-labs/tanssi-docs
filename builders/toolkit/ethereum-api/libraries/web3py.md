...
In this guide, you'll learn how to use setup the Web3.py library for your Tanssi EVM appchain. Next, to showcase the library in action, you'll use Web3.py to send a transaction and deploy a contract on a Tanssi EVM appchain running in Tanssi's [Dancebox](/builders/tanssi-network/testnet/dancebox/){target=\_blank} TestNet. This guide can be adapted for your own Tanssi EVM appchain by simply changing the endpoint.
