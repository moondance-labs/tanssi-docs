...
- **[eth_getBlockTransactionCountByHash](https://ethereum.org/developers/docs/apis/json-rpc/#eth_getblocktransactioncountbyhashh){target=\_blank}** — returns the number of transactions in a block with a given block hash
