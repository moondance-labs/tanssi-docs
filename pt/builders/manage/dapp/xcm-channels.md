...
1. **Conta Soberana** - é uma conta sem chave que pertence à rede em um sistema de consenso diferente, a cadeia de retransmissão neste caso. Ela só pode ser usada pelo governador da rede.
...
1. **Solicitações de canal de entrada/saída** - toda solicitação de canal precisa ser aceita pela contraparte antes que qualquer mensagem possa ser enviada.
...
1. **Canais estabelecidos** - Depois que o governador da cadeia de destino aceitar a solicitação do canal, o canal se torna aberto e disponível para transmissão de mensagens.
...
1. **Solicitação para abrir novos canais** - esta opção permite que você selecione uma rede existente no ecossistema e solicite a abertura de um canal. A [próxima seção](#request-new-channel) explica como fazer isso
...
Para fazer isso, clique em **Canais HRMP** e, em seguida:

1. Selecione a rede com a qual você deseja estabelecer um canal
1. Clique em **Solicitar Canal**
