...
- **Cunhar tokens** - cunha novos tokens, aumentando a oferta total
- **Atualizar saldos** - aumenta ou diminui o saldo de uma conta, afetando a oferta total
- **Transferir tokens** - executa uma transferência forçada de tokens de uma conta para outra
- **Configurar a dinâmica do gás** - disponível apenas em redes compatíveis com EVM, esta ação altera a configuração [EIP-1559](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1559.md){target=\_blank}, afetando o mecanismo de precificação da transação
...
1. Clique no botão **Gerenciar**
1. Clique no botão **Gerenciamento de Tokens**.
...
### Cunhando Tokens {: #minting-tokens }

O governador da rede pode cunhar novos tokens, aumentando sua oferta total. Para fazer isso, no painel **Gerenciamento de Tokens**, clique no botão **Cunhar tokens** e, em seguida:
...
1. Insira a quantidade de tokens a serem cunhados

1. Clique em **Cunhar**

![Cunhar tokens](/images/builders/manage/dapp/token-management/token-management-3.webp)
...
### Atualizando Saldos {: #updating-balances }

O governador da rede pode aumentar ou diminuir o saldo de qualquer conta, afetando, assim, a oferta total. Para fazer isso, no painel **Gerenciamento de Tokens**, clique no botão **Atualizar Saldos** e, em seguida:
...
1. Insira o novo saldo que o endereço conterá

1. Clique em **Atualizar**

![Atualizar Saldos](/images/builders/manage/dapp/token-management/token-management-4.webp)
...
O governador da rede pode reatribuir saldos, forçando uma transferência de tokens de uma conta para outra. Para fazer isso, no painel **Gerenciamento de Tokens**, clique no botão **Transferir Tokens** e, em seguida:

1. Insira o endereço de origem que transferirá seus tokens

1. Insira o endereço de destino que receberá os tokens
...
1. Insira a quantidade de tokens a serem transferidos
