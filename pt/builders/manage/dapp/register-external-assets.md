...
## Acessando o Painel de Registro de Ativos Externos {: #acessando o painel de registro de ativos externos }
...
3. **Asset Registration** - esta opção permite que você selecione outros ativos externos disponíveis e registre-os. A [seção a seguir](#registrar-um-ativo-externo) explica como fazê-lo
...
## Registrar um Ativo Externo {: #registrar-um-ativo-externo }
