...
- A conta Sudo da sua rede conectada aos seus Polkadot.js Apps. Você pode consultar o [guia de gerenciamento do Sudo](/builders/manage/developer-portal/sudo/#configuring-polkadotjs-apps){target=\_blank} para obter instruções sobre como injetar sua conta Sudo nos Polkadot.js Apps
...
1. Navegue até a guia **Desenvolvedor** do [Polkadot.js Apps](/builders/manage/developer-portal/sudo/#configuring-polkadotjs-apps){target=\_blank} e clique em **Chain State** (Estado da Cadeia)
1. Selecione o pallet **system** para consultar
1. Selecione **account** (conta)
1. Cole o endereço da conta ou selecione-o no menu suspenso
1. Pressione o ícone **+**
1. Você verá as informações do saldo retornadas na parte inferior, incluindo saldos livres, reservados e congelados
...
Para atribuir um saldo de conta a uma conta, certifique-se de ter sua conta Sudo acessível no [Polkadot.js Apps](/builders/manage/developer-portal/sudo/#configuring-polkadotjs-apps){target=\_blank}. Em seguida, siga estas etapas:

1. Navegue até a guia **Desenvolvedor** dos Polkadot.js Apps para sua rede Tanssi
