...
1. Em **criação de conta no navegador**, selecione **Permitir a criação de conta local no navegador**
1. Pressione **Salvar**
...
1. Clique em **Sudo**. Se você não vir **Sudo** neste menu, não associou a conta Sudo ao Polkadot.js Apps. Certifique-se de que sua conta Sudo seja injetada pela sua carteira e conectada ao Polkadot.js Apps
1. Selecione o título **Definir chave Sudo**
1. Selecione a nova conta para a qual você transferirá os privilégios Sudo
1. Pressione **Reatribuir** e confirme a transação em sua carteira
