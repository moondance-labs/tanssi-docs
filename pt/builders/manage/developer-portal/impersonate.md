...
1. Selecione o método **sudoAs**
1. Selecione ou cole a conta desejada para personificar
1. Selecione a paleta desejada para a chamada a enviar. Neste caso, é a paleta **balances** (saldos)
1. Selecione o método **transferAllowDeath**
1. Especifique a conta de destino para a transferência de saldo
1. Especifique o número de tokens a enviar
...
Para fazer isso, navegue para o separador **Developer** (Desenvolvedor) dos Polkadot.js Apps para a sua rede com tecnologia Tanssi e clique em **Sudo**. Se não vir **Sudo** neste menu, não associou a conta Sudo aos Polkadot.js Apps. Certifique-se de que a sua [conta Sudo está injetada pela sua carteira e conectada aos Polkadot.js Apps](/builders/manage/developer-portal/sudo/#configuring-polkadotjs-apps){target=\_blank}. Em seguida, siga os seguintes passos:

1. Selecione a paleta **Sudo**
1. Selecione o método **Sudo**
1. Selecione a paleta desejada para a chamada a enviar. Neste caso, é a paleta **utility** (utilidade)
1. Selecione o método **dispatchAs**
1. Selecione **system** (sistema) no menu pendente
1. Selecione a origem **signed** (assinada), que define a origem da transação para ser a conta especificada em vez de root (raiz)
1. Selecione a paleta desejada para a chamada a enviar. Neste caso, é a paleta **balances** (saldos)
1. Selecione o método **transferAllowDeath**
1. Especifique a conta de destino para a transferência de saldo
1. Especifique o número de tokens a enviar
...
E é isso! A secção [Developer Portal](/builders/manage/developer-portal/) tem muitos mais guias sobre como gerir a sua rede Tanssi.
