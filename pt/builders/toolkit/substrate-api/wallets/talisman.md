...
1. Selecione **Importar via Frase de Recuperação**.
...
1. Cole sua semente.
1. Selecione quais contas você gostaria de importar.
1. Pressione **Importar**.
...
1. Certifique-se de que **Habilitar testnets** esteja marcado.
...
1. Opcionalmente, insira a URL do explorador de blocos da sua rede Tanssi, se aplicável.
1. Marque a caixa **Esta é uma testnet**, se aplicável.
1. Pressione **Adicionar Rede**.
...
1. Pressione **Conectar 1**. O valor mudará dependendo do número de contas que você está conectando
...
1. Insira o **valor**.
1. Pressione **Fazer Transferência** e confirme a transação no pop-up Polkadot.js resultante.
