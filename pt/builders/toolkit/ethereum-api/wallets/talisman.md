...
2. Cole a URL do block explorer da sua rede Powered by Tanssi. A URL do block explorer da rede EVM de demonstração é `{{ networks.dancelight.demo_evm_blockscout_url }}`
