...
A [pré-compilação de ativos ERC-20](https://github.com/moondance-labs/tanssi/blob/master/test/contracts/solidity/ERC20Instance.sol){target=\_blank} permite que as redes baseadas no [Template Tanssi EVM](/builders/build/templates/evm/){target=\_blank} acessem qualquer ativo externo registrado através da interface ERC-20 padrão. Consequentemente, contratos inteligentes implantados na rede podem interagir com esses ativos da mesma forma que fariam com qualquer outro ERC-20 regular.
