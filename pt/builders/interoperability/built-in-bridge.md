...
- Uma [carteira compatível com Substrate](/builders/toolkit/substrate-api/wallets/){target=\_blank}, como [Talisman](/builders/toolkit/substrate-api/wallets/talisman/){target=\_blank}.
...
- Uma [carteira compatível com Ethereum](/builders/toolkit/ethereum-api/wallets/){target=\_blank}, como [MetaMask](/builders/toolkit/ethereum-api/wallets/metamask/){target=\_blank}.
...
1. Selecione **Mainnet** no menu suspenso **De**.
1. Clique em **Conectar Carteira**. Uma janela pop-up aparecerá, permitindo que você selecione sua carteira Substrate preferida e escolha a conta correspondente.
...
1. Selecione a conta de destino no menu suspenso **Selecionar endereço do destinatário** ou escolha o item **Inserir um endereço personalizado** e insira manualmente a conta para onde deseja receber os tokens ERC-20.
1. Insira o valor a ser transferido no campo **Saldo**. As taxas estimadas de ponte e transação serão exibidas junto com o valor que a conta de destino receberá.
1. Clique em **Enviar** e assine a transação.
...
1. Selecione **Ethereum** no menu suspenso **De**.
1. Clique em **Conectar Carteira**, selecione sua carteira Ethereum preferida e escolha a conta.

![Selecione Ethereum e conecte a carteira](/images/builders/interoperability/built-in-bridge/built-in-bridge-3.webp)

Agora, com sua carteira conectada:

1. Insira a conta de destino Substrate no campo **Destinatário**.
1. Insira o valor a ser transferido no campo **Saldo**. As taxas estimadas de ponte e transação serão exibidas junto com o valor que a conta de destino receberá.
1. Clique em **Enviar** e assine a transação.
