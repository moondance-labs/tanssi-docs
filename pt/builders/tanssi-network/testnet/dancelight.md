---
title: Começar a Usar a Dancelight
...
Esta página de referência rápida oferece todos os elementos essenciais que você precisa para começar a usar a Dancelight.

## Tokens da TestNet {: #testnet-tokens }

Os tokens {{ networks.dancelight.token_symbol }} servem como a moeda nativa dentro da Tanssi Network. Para iniciar a implantação de uma rede na Dancelight, você precisará obter tokens {{ networks.dancelight.token_symbol }}. Siga estas etapas:
...
Para a Dancelight, você pode usar os seguintes exploradores de blocos:
...
O suporte para exploradores de blocos adicionais está em andamento e, à medida que mais exploradores suportarem a Dancelight, esta seção será atualizada de acordo.
