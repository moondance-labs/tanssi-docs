---
title: Adicionando Módulos Externos
...
# Adicionando um Módulo Externo {: #adding-external-module }

## Introdução {: #introduction }

Desenvolvedores construindo sobre os [Templates oferecidos pela Tanssi](/builders/build/templates/){target=\_blank} podem querer adicionar alguns módulos/dependências externos em seu tempo de execução para expandir certas funcionalidades.
...
Semelhante ao que é descrito no artigo [módulo embutido](/builders/build/customize/adding-built-in-module/#adding-a-built-in-module-to-runtime){target=\_blank}, a adição de um módulo de terceiros requer as seguintes etapas:
