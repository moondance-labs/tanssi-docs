...
# Adicionar um Módulo Externo {: #adicionar-um-módulo-externo }
...
## Resolvendo Conflitos de Dependências com Diener {: #resolvendo-conflitos-de-dependências-com-diener }
...
## Exemplo do Problema de Dupla Referência {: #problema-de-dupla-referência }
...
### Adicionar uma Dependência de Terceiros {: #adicionar-uma-dependência-de-terceiros }
...
1. Torne as características padrão disponíveis para o compilador
1. Configure e adicione o módulo ao tempo de execução
...
### Declarando a Dependência {: #declarando-a-dependência }
...
### Tornando os Recursos Padrão Disponíveis para o Compilador {: #adicionar-recursos-padrão  }
...
### Configurar e Adicionar o Módulo ao Tempo de Execução {: #configurar-o-módulo-ao-tempo-de-execução }
...
### Compilar o Tempo de Execução {: #compilar-o-tempo de execução }
...
### Dependências de Patch {: #dependências-de-patch}
