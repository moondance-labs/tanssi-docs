...
Uma imagem Docker combina o binário correspondente à versão estável mais recente do [nó cliente](/learn/framework/architecture/#architecture){target=\_blank}, junto com o arquivo de especificação do orquestrador Tanssi.
